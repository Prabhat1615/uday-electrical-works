  ...
  return (
    ...
    >
      <Link to={`/shop/product/${product._id}`} className="flex flex-col flex-1">
        ...
        <div className="relative h-36 sm:h-40 w-full p-3 bg-slate-50/80 dark:bg-slate-950/60 flex items-center justify-center overflow-hidden border-b border-slate-100 dark:border-slate-800/80">
