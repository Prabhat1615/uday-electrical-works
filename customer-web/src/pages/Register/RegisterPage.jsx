    ...
    <div className="relative min-h-[85vh] flex items-center justify-center px-4 py-12 overflow-hidden bg-gradient-to-b from-slate-50 to-slate-100 dark:from-slate-950 dark:to-slate-950">
      ...
      >
        ...
        <div className="text-center space-y-2">
          ...
          <h2 className="text-2xl font-black text-slate-900 dark:text-white font-display">Create Customer Account</h2>
          <p className="text-xs text-slate-500 dark:text-slate-400">Register to book services, track orders & pay invoices online</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className={labelClass}>Company / Home Address</label>
            <div className="relative">
              <MapPin className="w-4 h-4 text-slate-400 absolute left-3.5 top-3" />
              <textarea
                rows={2}
                placeholder="Plot no, locality..."
                value={address}
