              ...
              <tbody className="divide-y divide-slate-100">
                {amcs.map((a) => (
                  <tr key={a._id} className="hover:bg-slate-50 transition-colors">
                    <td className="px-4 py-2.5 font-mono font-bold text-orange-600">{a.contractNumber}</td>
                    <td className="px-4 py-2.5 font-bold text-slate-900">{a.customer?.name}</td>
                    <td className="px-4 py-2.5 text-slate-600 font-semibold">{a.serviceType}</td>
                    <td className="px-4 py-2.5 text-sky-600 font-bold">{a.visitFrequency}</td>
                    <td className="px-4 py-2.5 text-slate-500">
                      {formatDate(a.startDate)} - {formatDate(a.endDate)}
                    </td>
                    <td className="px-4 py-2.5 font-bold text-slate-900">{formatCurrency(a.totalAmount)}</td>
                    ...
                    <td className="px-4 py-2.5 text-right space-x-2">
                      <button
                        ...
                        className="px-3 py-1.5 rounded-lg bg-orange-500/10 hover:bg-orange-600 border border-orange-500/30 text-orange-600 hover:text-white font-bold transition-all"
                      >
                        Renew 1-Yr
                      </button>
                    </td>
